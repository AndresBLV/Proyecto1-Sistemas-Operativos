 ...
 * @author sebas
 */
public class ProcesosPMDE1 extends Thread {
    ...
    public ProcesosPMDE1(int tipo,long dia,Semaphore mod,JLabel countdown,JLabel accion){
        this.stop=true;
    ...
    public ProcesosPMDE1(long dia,int tipo,Semaphore mod,JLabel accion,JLabel countdown,JLabel episodio,JLabel accionPM,JLabel saldoPM){
        this.stop=true;
        this.modCountdown = mod;
        this.countdown = countdown;
        this.accion=accion;
    ...
    public void run(){            
       ...
       try {
           ...
           Logger.getLogger(ProcesosPMDE1.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
        if (tipo==2) {
